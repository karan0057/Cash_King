package com.cultofgames.funearn.Adapter;
...
public class SliderFAdapter extends SliderViewAdapter<SliderFAdapter.SliderViewHolder> {

    private ArrayList<Slider> list;
    private Context context;


    public SliderFAdapter(ArrayList<Slider> list, Context context) {
        this.list = list;
