...
import static com.cultofgames.funearn.helper.Constatnt.TASK;
...
import com.cultofgames.funearn.csm.adapter.Task_adapter;
import com.cultofgames.funearn.csm.model.Task_model;
...
public class Refer_Activity extends AppCompatActivity {
    ...
    public void getquizlist() {
        JsonRequest stringRequest = new JsonRequest(Request.Method.POST,
            ...
            public void onErrorResponse(VolleyError error) {
                ContextExtensionKt.showLongToast(Refer_Activity.this, error.toString());
                //  hidepDialog();
            }
        }) {
            @Override
    ...
    private void parseJsonFeed(JSONObject response) {
        try {
            ...
            e.printStackTrace();
            ContextExtensionKt.showLongToast(Refer_Activity.this, "error");
