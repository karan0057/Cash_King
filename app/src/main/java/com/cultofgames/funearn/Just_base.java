...
import static com.cultofgames.funearn.helper.Constatnt.FCM_ID;
...
import static com.cultofgames.funearn.helper.Constatnt.UPDATE_FCM;
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (response.getString("error").equalsIgnoreCase("false")) {
                                ...
                                ContextExtensionKt.showShortToast(context,  response.getString("message"));
                            }
                        } catch (Exception e) {
