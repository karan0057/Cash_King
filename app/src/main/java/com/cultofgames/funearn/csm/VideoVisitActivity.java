...
import static com.cultofgames.funearn.helper.Helper.VISIT_REQUEST_CODE;
import static com.cultofgames.funearn.helper.PrefManager.BANNER_AD_TYPE;
import static com.cultofgames.funearn.helper.PrefManager.CHARTBOOST_AD_TYPE;
import static com.cultofgames.funearn.helper.PrefManager.INTERSTITAL_AD_TYPE;
import static com.cultofgames.funearn.helper.PrefManager.getSavedString;
...
import com.cultofgames.funearn.AdsManager;
import com.cultofgames.funearn.OnVideoAdEnded;
import com.cultofgames.funearn.R;
import com.cultofgames.funearn.UpdateListener;
import com.cultofgames.funearn.csm.adapter.WebsiteAdapter;
...
public class VideoVisitActivity extends AppCompatActivity implements UpdateListener {
    ...
    private void showDialogPoints(final int addNoAddValueVideo, final String points) {
        ...
        if (PrefManager.isConnected(activity)) {
            ...
            ContextExtensionKt.showShortToast(activity, "Please Check your Internet Connection");
        }
    }
