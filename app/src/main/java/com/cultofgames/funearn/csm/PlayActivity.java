...
import com.cultofgames.funearn.helper.CircularTimerListener;
import com.cultofgames.funearn.helper.CircularTimerView;
import com.cultofgames.funearn.helper.ContextExtensionKt;
import com.cultofgames.funearn.helper.JsonRequest;
import com.cultofgames.funearn.helper.TimeFormatEnum;
...
public class PlayActivity extends AppCompatActivity {
    ...
    public void getList() {
        JsonRequest stringRequest = new JsonRequest(Request.Method.POST,
            ...
            ContextExtensionKt.showLongToast(PlayActivity.this, error.toString());
                }
                ) {
            @Override
    ...
    private void parseJsonFeed(JSONObject response) {
        try {
            ...
            e.printStackTrace();
            ContextExtensionKt.showLongToast(PlayActivity.this, e.toString());
        }
    }
