...
import static com.cultofgames.funearn.helper.AppController.getInstance;
...
import static com.cultofgames.funearn.helper.PrefManager.IRON_SOURCE_APP_KEY;
...
import com.cultofgames.funearn.csm.adapter.OfferWall_Adapter;
                    ...
                    case "o":
                        ...
                        if (feedObj.getString("offer_name").equals("adget") || feedObj.getString("offer_name").equals("toro") ||
                            ...
                            OfferWall_Model item = new OfferWall_Model(feedObj.getString("title"), feedObj.getString("sub"),
                                    feedObj.getString("image"), feedObj.getString("offer_name"), feedObj.getString("points"));
                            offers.add(item);
                        }
                        break;
                    case "v":
